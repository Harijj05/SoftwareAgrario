...
from models import Hectarea
from db import obtener_personas, obtener_tipo_hortaliza, obtener_tipo_suelo, obtener_climas
...
class TipoCultivoManagementScreen(QWidget):
    ...
    def cargar_en_formulario(self, item):
        ...
        primera_str = parts[2].strip()
        rutinaria_str = parts[3].strip()
        try:
